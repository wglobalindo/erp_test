 ...
 */
class pdf_supplier_order extends ModelePDFSuppliersOrders
{
    var $db;
    var $name;
    var $description;
		...
		if ($conf->fournisseur->commande->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				for ($i = 0 ; $i < $nblignes ; $i++)
				{
					...
					if($conf->global->PRODUCT_USE_UNITS)
					{
						$pdf->MultiCell($this->posxunit-$this->posxqty-0.8, 4, $qty." ".$unit_name, 0, 'R');
					}
					else
					{
						$pdf->MultiCell($this->posxdiscount-$this->posxqty-0.8, 4, $qty." ".$unit_name, 0, 'R');
					}
