 ...
 */
class pdf_pronew extends ModelePDFPropales
{
	var $db;
	var $name;
	var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "pronew";
		$this->description = $langs->trans('testDocument');
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		$pdf->MultiCell(100, 20, $outputlangs->convToOutputCharset($this->emetteur->name), 0, 'L');
