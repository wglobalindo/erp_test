...
class pdf_shipment extends ModelePdfExpedition
{
	...
	function __construct($db=0)
	{
		...
		$this->db = $db;
		$this->name = "shipment";
		$this->description = $langs->trans("DocumentModelShipment");
    ...
    // Logo
		...
		//company name START
		$pdf->SetXY($this->marge_gauche+20,$posy-1);
   		$pdf->SetFont('','B', $default_font_size + 2);
		$pdf->MultiCell(80, 20, $outputlangs->convToOutputCharset($this->emetteur->name), 0, 'L');
		//company name END
